...
intierdirpredf_long <- pivot_longer(intierdirpredf, cols = c(TGES, GES), names_to = "Method", values_to = "value")
intierdirrecdf_long <- pivot_longer(intierdirrecdf, cols = c(TGES, GES), names_to = "Method", values_to = "value")
